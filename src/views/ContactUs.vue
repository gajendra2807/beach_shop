...
<div class="contact_us_2">
  <div class="responsive-container-block big-container">
    ...
    <div class="responsive-container-block container">
      <form class="form-box" @click="handleSubmit" >
        <div class="container-block form-wrapper">
          ...
          <div class="responsive-container-block">
            <div class="responsive-cell-block wk-ipadp-6 wk-tab-12 wk-mobile-12 wk-desk-6" id="i10mt">
              ...
              <input class="input" type="text" id="ijowk" name="FirstName" placeholder="Please enter first name..." v-model="firstname">
            </div>
            <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
              <p class="text-blk input-title">
                LAST NAME
              </p>
              <input class="input" type="text" id="indfi" name="Last Name" placeholder="Please enter last name..." v-model="lastname">
            </div>
            <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
              <p class="text-blk input-title">
                EMAIL
              </p>
              <input class="input" type="text" id="ipmgh" name="Email" placeholder="Please enter email..." v-model="email">
            </div>
            <div class="responsive-cell-block wk-desk-6 wk-ipadp-6 wk-tab-12 wk-mobile-12">
              <p class="text-blk input-title">
                PHONE NUMBER
              </p>
              <input class="input" type="number" id="imgis" name="PhoneNumber" placeholder="Please enter phone number..." v-model="phonenumber">
            </div>
            <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-12 wk-ipadp-12" id="i634i">
              <p class="text-blk input-title">
                WHAT DO YOU HAVE IN MIND
              </p>
              <textarea class="textinput" type="text" id="i5vyy" placeholder="Please enter query..." v-model="whatdoyouhaveinmind"></textarea>
            </div>
          </div>
...
methods: {
  handleSubmit() {
    let userMessage = {
      ...
      whatdoyouhaveinmind: this.whatdoyouhaveinmind
    }
